Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "lawson_#{Rails.env}"
  ...
  #   protocol: "https", host: Settings.config.mailer.host
  # }

  # config.middleware.use ExceptionNotification::Rack, chatwork: {}
end
